...
public class UserAssetProvisioningMQTTHandler extends MQTTHandler {
  ...
  protected void processMTLSProvisioningMessage(RemotingConnection connection, Topic topic) {
    ...
    // The message carries no certificate: the client already proved possession of one during the
    // handshake, and that is the certificate this flow provisions against
